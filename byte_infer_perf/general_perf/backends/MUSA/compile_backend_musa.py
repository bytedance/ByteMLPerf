...
log = logging.getLogger("CompileBackendMUSA")
...
class CompileBackendMUSA(compile_backend.CompileBackend):
    def __init__(self):
        super(CompileBackendMUSA, self).__init__()
    ...
    def get_interact_profile(self, config):
        model_profile = []
        file_path = "general_perf/backends/MUSA/MUSA.json"

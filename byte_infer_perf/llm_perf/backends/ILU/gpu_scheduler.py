...
class GpuScheduler(CoreScheduler):
    ...
    def scheduler_loop(self):
        ...
        while True:
            ...
            logger.info(f"@@@@@@@@@@@@@@  5. add result to packet ")
            ...
            logger.info(f"@@@@@@@@@@@@@@  6. is not finished -> remain ")        
            batch = remained

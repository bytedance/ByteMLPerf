...
from megatron.core.transformer.deepseek_transformer_layer import BaseTransformerLayer
...
@dataclass
class DeepseekTransformerBlockSubmodules:
    """
...
def _get_block_submodules(
    config: TransformerConfig, spec: Union[DeepseekTransformerBlockSubmodules, ModuleSpec]
) -> DeepseekTransformerBlockSubmodules:
    """
    ...
    if isinstance(spec, DeepseekTransformerBlockSubmodules):
        return spec
    ...
    # `BaseTransformerLayer` from the `transformer_layer.py` file.
        ...
        if issubclass(spec.module, DeepseekTransformerBlock):
            return spec.submodules
        elif issubclass(spec.module, BaseTransformerLayer):
            num_layers = get_num_layers_to_build(config)
            return DeepseekTransformerBlockSubmodules(
...
class DeepseekTransformerBlock(MegatronModule):
    """Transformer class."""

    def __init__(
        self,
        config: TransformerConfig,
        spec: Union[DeepseekTransformerBlockSubmodules, ModuleSpec],

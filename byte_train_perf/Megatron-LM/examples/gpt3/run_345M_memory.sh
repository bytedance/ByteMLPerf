...
# OUTPUT path
LOG_ADDR_EXISTS=/projs/platform/a100_345M_memory.log
MAX_TRAIN_STEPS=2000
OUTPUT_CMP_ADDR=./output/gpt3_345M_memory_log
...
LOG_FILE_PATH="${OUTPUT_CMP_ADDR}/mlu_345M_memory.log"
...
# Runs the "345M" parameter model
bash examples/gpt3/train_gpt3_345M_distributed_memory.sh $CHECKPOINT_SAVE_PATH $TENSORBOARD_LOGS_PATH $VOCAB_FILE $MERGE_FILE $DATA_PATH $PRETRAIN_MODEL_PATH $MAX_TRAIN_STEPS 2>&1 | tee $LOG_FILE_PATH
python3 memory_chart.py -b $LOG_ADDR_EXISTS -i $LOG_FILE_PATH -o memory_stability_max_allocated  -s 50 -t 0.002
python3 memory_chart.py -b $LOG_ADDR_EXISTS -i $LOG_FILE_PATH --reserved -o memory_stability_max_reserved  -s 50 -t 0.002
python3 memory_chart.py -b $LOG_ADDR_EXISTS -i $LOG_FILE_PATH --fragment -o memory_stability_fragment  -s 50 -t 0.002

...
PRETRAIN_MODEL_PATH=/projs/platform/ckpt_857M/ckpt
CHECKPOINT_SAVE_PATH=/data02/huanghantao/Megatron-LM/examples/gpt3/ckpt_857M/ckpt
TENSORBOARD_LOGS_PATH=/data02/huanghantao/Megatron-LM/examples/gpt3/ckpt_857M/tensorboard
...
# OUTPUT path
LOG_ADDR_EXISTS=/projs/platform/a100_857M_finetune_bf16.log
MAX_TRAIN_STEPS=500000
OUTPUT_CMP_ADDR=./output/gpt3_857M_log
...
LOG_FILE_PATH="${OUTPUT_CMP_ADDR}/mlu_857M_loss.log"
...
# Runs the "857M" parameter model
bash examples/gpt3/train_gpt3_857M_distributed.sh $CHECKPOINT_SAVE_PATH $TENSORBOARD_LOGS_PATH $VOCAB_FILE $MERGE_FILE $DATA_PATH $PRETRAIN_MODEL_PATH $MAX_TRAIN_STEPS 2>&1 | tee $LOG_FILE_PATH 

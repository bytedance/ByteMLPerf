...
MAX_TRAIN_SAMPLES=$6      # train samples, eg. 92160000 (1w iter)
BATCH_WARMUP_SAMPLES=$(($MAX_TRAIN_SAMPLES / 31)) 
DECAY_SAMPLES=$(($MAX_TRAIN_SAMPLES / 2)) 
LR_WARMUP_SAMPLES=$(( 2000 * 9216 ))
...
TRAINING_ARGS=(
    --seed 1234
    --micro-batch-size 1
    --global-batch-size 9216
    --lr 2.4e-4
    --train-samples $MAX_TRAIN_SAMPLES
    --rampup-batch-size 512 128 $BATCH_WARMUP_SAMPLES

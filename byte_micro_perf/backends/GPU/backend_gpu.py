...
# find all python files in ops, and collect OP_MAPPING
GPU_OP_MAPPING = {}
for file in FILE_DIR.joinpath("ops").glob("*.py"):
    try:
        module = importlib.import_module(f"backends.GPU.ops.{file.stem}")
        GPU_OP_MAPPING[file.stem] = module.OP_MAPPING
    except:
        continue
